...
c        write(io,9901)
c        call sbout1(io,nparam,'x                   ',dummy,x,2,1)
        prnt=.true.
...
c          if(i.eq.1) write(io,1001) delta
c          if(i.ne.1) write(io,1002) delta
  9     x(i)=xi+delta
        xisnew=.true.
...
c
 ...
 110  continue
c      if(iter.le.1) write(io,9909)
c      if(iter.le.1.and.ipspan.lt.10) write(io,9900) iter
...
c
      if (job.eq.2) goto 10
c      if (level.eq.1)write(io,9900) s1,z
c      if (level.eq.2)write(io,9901) s1,z
      return
 10   if(n.eq.0) goto 101
c      if (level.eq.1)write(io,9900) s1,z1(1)
c      if (level.eq.2)write(io,9901) s1,z1(1)
      do 100 j=2,n
c        if (level.eq.1) write(io,9902) z1(j)
c        if (level.eq.2) write(io,9903) z1(j)
 100  continue
 101  return
